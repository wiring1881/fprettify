...
F90_KEYWORDS_RE = re.compile(r"\b(" + "|".join((
    ...
    "interface", "intrinsic", "is", "logical", "module", "namelist", "none",
        ...
        if what_del_open or what_del_close:
            ...
            # format closing delimiters
                ...
                if not re.search(r"^\s*(" + DEL_CLOSE_STR + r"|[,%:/\*])",
                    ...
                    sep2 = 1 * spacey[8]
                    if (sep2 == 0 and
                        not re.search(r"^\s*THEN" + EOL_STR,
                                  line[pos + 1:], RE_FLAGS)):
                        sep2 = 1
...
def preprocess_line(f_line, lines, comments, filename, line_nr, indent_fypp, in_format_off_block, impose_case, nest):
    ...
    lines0_strip = lines[0].lstrip()
    if FYPP_LINE_RE.search(lines0_strip):
        #--- MODIFIED_13: Don't indent fypp call and eval directive within nested block.
        #>>> is_fypp = True
